public class Main {
    public static void main(String[] args) {
        ...
        FitnessUser user = new FitnessUser("Aknur", "Kulbay", "Active");

        FitnessUserDAO.addUser(user);   // WRITE
        ReadUsers.readUsers();          // READ
        UpdateUser.updateStatus(1, "Premium"); // UPDATE
        DeleteUser.deleteUser(1);       // DELETE
    }
}
